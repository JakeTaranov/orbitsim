...
int main()
{
    sf::RenderWindow window(sf::VideoMode(1600, 1000), "Orbit Simulation");
    ...
    while (window.isOpen())
    {
        ...
        particle.update_color(sf::Color::Color(static_cast<unsigned int>(particle.get_velocity()), static_cast<unsigned int>(particle.get_velocity()) * 100, static_cast<unsigned int>(particle.get_velocity())));
